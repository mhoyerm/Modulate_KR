...
def main():
    ...
    ratio = input('K/R: ')
    if ratio < 0:
        print 'Do not enter negative values for K/R.'
        sys.exit()
    ...
    for prot in proteins:
        ...
        kr, peptides = evaluate(seqfinal, fieldSize,Charges)
        n = evaluate_KR(kr,ratio)
